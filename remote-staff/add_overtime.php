...
if (isset($_POST['apply'])) {
    ...
    $sql = "INSERT INTO overtime_requests (employee_id, first_name, last_name, position, staff_id, overtime_date, start_time, end_time, total_hours, details) 
            VALUES ('$session_id', '$first_name', '$last_name', '$position', '$staff_id', '$overtime_date', '$start_time', '$end_time', '$total_hours', '$details')";
