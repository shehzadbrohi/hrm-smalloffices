			...
			<div class="row pb-10">
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php
						$sql = "SELECT id from overtime_requests  where position = 'Social Media Admin'";
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $status=1;
						 $query = mysqli_query($conn,"select * from overtime_requests where  hod_approval = '$status' and position = 'Social Media Admin'")or die(mysqli_error());
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $status=0;
						 $query_pend = mysqli_query($conn,"select * from overtime_requests where  hod_approval = '$status'  and position = 'Social Media Admin'")or die(mysqli_error());
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $status=2;
						 $query_reject = mysqli_query($conn,"select * from overtime_requests where  hod_approval = '$status'  and position = 'Social Media Admin'")or die(mysqli_error());
						...
						<tbody>
							<tr>
								 ...
								 <?php 
                                    ...
                                    $sql = "SELECT * from overtime_requests  where position = 'Social Media Admin'";
                                    $query = $dbh -> prepare($sql);
                                    $query->execute();
                                    $results=$query->fetchAll(PDO::FETCH_OBJ);
                                    $cnt=1;
