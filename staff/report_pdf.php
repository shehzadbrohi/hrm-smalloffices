<?php
	...
	class PDF extends TCPDF
	{
	    ...
	    {
			$this->Image('teamnetlogo.png',10,10,100,0,'PNG');
	    	$this->Ln(15);
			$this->Ln(15);
	    	$this->SetFont('helvetica','B', 14);
	    	$this->Cell(189, 5, 'Karsh General Trading Co. L.L.C', 0, 1, 'C');
	    	$this->SetFont('helvetica','B', 14);
	    	$this->Ln(5);
	    	$this->Cell(189, 3, 'Office 2707 27th Floor Latifa Tower, Sheikh Zayed Road Dubai', 0, 1, 'C');
	    	$this->SetFont('helvetica','B', 14);
	    	$this->Ln(5);
	...
	$pdf->SetAuthor('Teamnet by Karsh');
	$pdf->SetTitle('Teamnet by Karsh');
	$pdf->SetSubject('');
	$pdf->SetKeywords('');
	...
	$pdf->Cell(189, 6, 'Full Name:    '.$firstname.' '.$lastname.'', 0, 1);

	$pdf->Ln(8);
	$pdf->SetFont('times','B', 12);
	$pdf->Cell(130, 6, 'Position:    '.$position.' ', 0, 0);
	...
	$pdf->SetFont('times','B', 12);
	$pdf->Cell(189, 6, 'Number of days requested:    '.$num_days.' ', 0, 1);

	$pdf->Ln(10);
	
	$pdf->SetFont('times','B', 12);
	$pdf->Cell(189, 6, 'Number of days still outstanding:    '.$outstanding.' ', 0, 1);

	$pdf->Ln(10);
	
	$pdf->SetFont('times','B', 12);
	$pdf->Cell(130, 6, 'Start date:    '.$start_date.' ', 0, 0);
	$pdf->Cell(59, 6, 'End Date:   '.$end_date.'');

	$pdf->Ln(12);
	$pdf->SetFont('times','B', 12);
	$pdf->Cell(34, 15, 'Signature : .............................', 0, 0);
	...
	$pdf->SetFont('times','B', 12);
	$pdf->Cell(95, 18, 'Recommendation By (Head of Department): ......................', 0, 0);
	...
	$pdf->SetFont('times','B', 12);
	$pdf->Cell(189, 6, 'Work to be covered by:    '.$work_cover.' ', 0, 1);

	$pdf->Ln(8);
	
	$pdf->SetFont('times','B', 12);
	$pdf->Cell(75, 18, 'Approved By (CEO/Manager): ......................', 0, 0);
	...
	$pdf->SetFont('times','B', 12);
	$pdf->Cell(189, 6, 'Date Resumed (for official work):    '.$end_date.' ', 0, 1);

	// Close and output PDF document
	$pdf->Output('teamnet_1.pdf', 'I');
