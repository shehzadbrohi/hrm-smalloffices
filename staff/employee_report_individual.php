						...
						<tbody>
							...
							<tr>
								 ...
								 <?php 
                                    ...
                                    $sql = "SELECT * FROM tblemployees JOIN tbldailyreport ON tblemployees.emp_id=tbldailyreport.empid WHERE tblemployees.emp_id=14 Order By tbldailyreport.staffreportdate desc";
