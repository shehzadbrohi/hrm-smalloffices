		...
		<div class="pd-ltr-20">
			...
			<div class="row pb-10">
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					...
					<?php
    $sql = "SELECT SUM(total_hours) AS total_overtime_hours 
            FROM overtime_requests 
            WHERE employee_id='$session_id' 
            AND overtime_date BETWEEN '2024-05-24' AND '2024-06-23' 
            AND hod_approval=1;";
...
?>
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-24 text-dark"><?php echo($total_overtime_hours);?></div>
