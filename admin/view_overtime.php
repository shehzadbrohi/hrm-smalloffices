...
$query="update overtime_requests set ceo_approval=1 where id='$rmid'";
...
echo "<script>window.location.assign('view_overtime.php')</script>";
	...
	$query="update overtime_requests set ceo_approval=2 where id='$rmid'";
	$sql=mysqli_query($conn,$query);
	echo "<script>alert('Overtime rejected Successfully')</script>";
	echo "<script>window.location.assign('view_overtime_remote.php')</script>";
			...
			<div class="row pb-10">
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $status=1;
						 $query = mysqli_query($conn,"select * from overtime_requests where  ceo_approval = '$status'")or die(mysqli_error());
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $status=0;
						 $query_pend = mysqli_query($conn,"select * from overtime_requests where  ceo_approval = '$status'")or die(mysqli_error());
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $status=2;
						 $query_reject = mysqli_query($conn,"select * from overtime_requests where  ceo_approval = '$status'")or die(mysqli_error());
					...
					<table class="table table-responsive hover nowrap" id="mytb">
						<thead>
							<tr>
								...
								<th class="datatable-nosort">Employee Name</th>
								<th class="table-plus">Overtime Date</th>
								<th>Start Time</th>
								<th>End Time</th>
								<th>Total Hours</th>
								<th>Details</th>
						...
						<tbody>
							<tr>
								 ...
								 <?php 
                                    ...
                                    $sql = "SELECT * from overtime_requests where hod_approval=1 and position!='Social Media Admin' AND overtime_date >= '2024-05-26'";
                                    $query = $dbh -> prepare($sql);
                                    $query->execute();
                                    $results=$query->fetchAll(PDO::FETCH_OBJ);
                                    $cnt=1;
