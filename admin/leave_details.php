...
<?php
	...
	{ 
		...
		$queryleave=mysqli_query($conn,"select * from tblleave where id='$did'");
		$dataleave=mysqli_fetch_assoc($queryleave);
		$leavetype=$dataleave['LeaveType'];
		...
		elseif ($status === '1') {
			...
			if($leavetype === 'Medical Leave'){
				...
				if ($result) {
			     	echo "<script>alert('Medical Leave approved Successfully');</script>";
				...
				if ($result) {
			     	echo "<script>alert('Unpaid Leave approved Successfully');</script>";
					 approve_leave_mail($hodFullname,$staffEmail, "APPROVED");
				...
				<div class="pd-20 card-box mb-30">
					...
					<form method="post" action="">
						...
						<div class="row">
							...
							<?php 
							$num_days = (float) $result->num_days; // Convert to float

									if($num_days === 0.38){
										?>
	<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Requested Number of Hours</b></label>

				
									<input type="text" class="selectpicker form-control" data-style="btn-outline-info" readonly name="num_days" value="3 Hours">
								</div>
							</div>
										<?php
									}
else if($num_days === 0.25){
	?>
<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Requested Number of Hours</b></label>
									...
									<input type="text" class="selectpicker form-control" data-style="btn-outline-info" readonly name="num_days" value="2 Hours">
								</div>
							</div>
	<?php
}
else if($num_days === 0.13){
	?>
<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Requested Number of Hour</b></label>

				
									<input type="text" class="selectpicker form-control" data-style="btn-outline-info" readonly name="num_days" value="1 Hour">
								</div>
							</div>
	<?php
}
...
<div class="col-md-4 col-sm-12">
						...
						<?php 
						if($result->LeaveType === 'Medical Leave'){

							?>
	<div class="form-group row">
								<div class="col-md-4 col-sm-12">
								<div class="form-group">
<img src="<?php echo htmlentities($result->Imagepath); ?>" alt="" height="200px">
								</div>
								</div>
						</div>
							<?php
						...
						<div class="form-group row">
							...
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>CEO/Manager Approval</b></label>
									<?php
									if ($result->RegSign==""): ?>
									  <input type="text" class="selectpicker form-control" data-style="btn-outline-primary" readonly value="<?php echo "NA"; ?>">
									<?php else: ?>
						...
						<div class="form-group row">
							...
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Date For CEO/Manager Action</b></label>
									<?php
									if ($result->RegDate==""): ?>
									  <input type="text" class="selectpicker form-control" data-style="btn-outline-primary" readonly value="<?php echo "NA"; ?>">
									<?php else: ?>
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									<label style="font-size:16px;"><b>Leave Status From CEO/Manager</b></label>
