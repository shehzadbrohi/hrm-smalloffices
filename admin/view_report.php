			...
			<div class="row pb-10">
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					...
					<div class="card-box height-100-p widget-style3">
						...
						$sql = "SELECT id from tbldailyreport";
...
$days15_ago = date('Y-m-d', strtotime('-2 days'));

// Construct the SQL query
$sql = "SELECT * 
        FROM tbldailyreport 
        WHERE staffreportdate BETWEEN '$days15_ago' AND '$current_date' 
        AND staffposition!='Social Media Admin' AND empid!=18 and empid!=16 and empid!=14 and empid!=15 and empid!=4
        ORDER BY staffreportdate DESC";
                                    $query = $dbh -> prepare($sql);
