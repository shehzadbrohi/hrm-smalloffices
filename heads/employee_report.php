			...
			<div class="row pb-10">
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					...
					<div class="card-box height-100-p widget-style3">
						...
						$sql = "SELECT * FROM tblemployees JOIN tbldailyreport ON tblemployees.emp_id=tbldailyreport.empid WHERE tblemployees.Department='$session_depart'  Order By tbldailyreport.staffreportdate desc";
						...
						<tbody>
							...
							<tr>
								 ...
								 <?php 
                                    ...
                                    $sql = "SELECT * FROM tblemployees JOIN tbldailyreport ON tblemployees.emp_id=tbldailyreport.empid WHERE tblemployees.Department='$session_depart' and empid!=33  Order By staffreportdate desc ";
