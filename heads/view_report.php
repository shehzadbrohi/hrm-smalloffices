			...
			<div class="row pb-10">
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					...
					<div class="card-box height-100-p widget-style3">
						...
						$sql = "SELECT id from tbldailyreport where empid='$session_id' Order By staffreportdate desc ";
...
$days15_ago = date('Y-m-d', strtotime('-15 days'));
// Construct the SQL query
$sql = "SELECT * 
        FROM tbldailyreport 
        WHERE staffreportdate BETWEEN '$days15_ago' AND '$current_date' 
        AND  empid = '$session_id' Order By staffreportdate desc";
